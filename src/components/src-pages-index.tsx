        ...
        <div className="container mx-auto px-4 py-6 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-4">
            ...
            {session ? (
              ...
              <button onClick={() => signIn()} className="text-gray-600 hover:text-blue-600">
                Sign In
              </button>
            )}
          </nav>
        ...
        <section className="bg-blue-600 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4">
              ...
              />
              <button className="bg-white text-blue-600 px-6 py-2 rounded-md font-semibold hover:bg-blue-100 transition duration-300">
                Search
              </button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400">Email: info@2clickbroker.com</p>
            </div>
          </div>
          <div className="mt-8 text-center text-gray-400">
            <p>&copy; 2023 2ClickBroker. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
