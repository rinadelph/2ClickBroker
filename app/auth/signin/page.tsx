            ...
            <TabsContent value="signin">
              <form onSubmit={handleSignIn} className="space-y-6">
                <div>
                  ...
                  <Input id="signinEmail" name="signinEmail" type="email" autoComplete="email" required className="mt-1" />
                </div>
                <div>
                  <Label htmlFor="signinPassword" className="block text-sm font-medium text-gray-700">
                    Password
                  </Label>
                  <Input id="signinPassword" name="signinPassword" type="password" autoComplete="current-password" required className="mt-1" />
                </div>
                <div>
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignUp} className="space-y-6">
                ...
                <div>
                  ...
                  <Input id="signupEmail" name="signupEmail" type="email" autoComplete="email" required className="mt-1" />
                </div>
                <div>
                  <Label htmlFor="signupPassword" className="block text-sm font-medium text-gray-700">
                    Password
                  </Label>
                  <Input id="signupPassword" name="signupPassword" type="password" autoComplete="new-password" required className="mt-1" />
                </div>
                <div>
                  <Button type="submit" className="w-full" disabled={isLoading}>
